...
/**
 * Created by Anurag on 27-02-2017.
 */
...
public class MapsActivity1 extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        LatLng latLng1=new LatLng(19.003689,73.125166);
        MarkerOptions markerOptions1=new MarkerOptions();
        markerOptions1.position(latLng1);
        markerOptions1.title("Kamal Arnav charitable trust");
        ...
        mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
        LatLng latLng2=new LatLng(19.038234,73.012929);
        MarkerOptions markerOptions2=new MarkerOptions();
        markerOptions2.position(latLng2);
        markerOptions2.title("Children of the world india trust");
        ...
        mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
        LatLng latLng3=new LatLng(19.037919,73.020972);
        MarkerOptions markerOptions3=new MarkerOptions();
        markerOptions3.position(latLng3);
        markerOptions3.title("Maitriya Trust");
        ...
        mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
        LatLng latLng4=new LatLng(19.063061,72.998905);
        MarkerOptions markerOptions4=new MarkerOptions();
        markerOptions4.position(latLng4);
        markerOptions4.title("Care Assure Foundation");
        ...
        mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
        LatLng latLng5=new LatLng(19.031886,73.040897);
        MarkerOptions markerOptions5=new MarkerOptions();
        markerOptions5.position(latLng5);
        markerOptions5.title("Swami Brahmanand Pratishthan");
        markerOptions5.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
