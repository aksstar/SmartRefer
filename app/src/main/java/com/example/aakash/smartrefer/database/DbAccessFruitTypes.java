package com.example.aakash.smartrefer.database;
...
import com.example.aakash.smartrefer.detectableObjects.*;
import com.example.aakash.smartrefer.information.*;
...
public class DbAccessFruitTypes extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "Veg.db";
    public static final String TABLE_NAME_FRUIT_TYPES = "fruitTypesTable";

    private static final String TAG = "Veg::database";
        ...
        for(int i = 0; i < count; i++) {
            ...
            try {
                ...
                nutritionalValue = new NutritionalValue(nutritionalValueVector[0],
                        ...
                        nutritionalValueVector[3], nutritionalValueVector[4],nutritionalValueVector[5]);
            } catch(Exception e) {
                Log.e(TAG, e.getMessage());
            }
